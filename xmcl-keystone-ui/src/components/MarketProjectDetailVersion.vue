...
const loaders = computed(() => props.version.loaders.map(l => {
  if (l.toLowerCase() === 'vanilla') return { icon: 'fl:minecraft', loader: l }
  if (l.toLowerCase() === 'forge') return { icon: 'fl:forge', loader: l }
  if (l.toLowerCase() === 'fabric') return { icon: 'fl:fabric', loader: l }
  if (l.toLowerCase() === 'quilt') return { icon: 'fl:quilt', loader: l }
  if (l.toLowerCase() === 'neoforge') return { icon: 'fl:neoForged', loader: l }
  if (l.toLowerCase() === 'iris') return { icon: 'fl:iris', loader: l }
  if (l.toLowerCase() === 'optifine') return { icon: 'fl:optifine', loader: l }
  return { loader: l }
}))
